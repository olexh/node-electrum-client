...
class ElectrumClient extends Client{
    ...
    blockchainScripthash_utxo(scripthash, amount){
        return this.request('blockchain.scripthash.utxo', [scripthash, amount])
    }
    ...
    blockchainTransaction_inputs(tx_hash){
        return this.request('blockchain.transaction.inputs', [tx_hash])
    }
...
// ---------------------------------
    ...
    blockchainAddress_getTokens(address){
        return this.request('blockchain.address.get_tokens', [address])
    }
    ...
    blockchainAddress_utxo(address, amount){
        return this.request('blockchain.address.utxo', [address, amount])
    }
    blockchainAddress_utxoTokens(address, token, amount){
        return this.request('blockchain.address.utxo_tokens', [address, token, amount])
    }
}
